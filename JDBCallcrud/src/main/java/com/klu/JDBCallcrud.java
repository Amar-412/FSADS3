...
public class JDBCallcrud {
	static String url="jdbc:mysql://localhost:3306/amar";
	  static String usr="root";
	 static String pwd="3945";
  ...
  // creation of employee and department table
	static void createTables() {
		try(Connection con = DriverManager.getConnection(url, usr,pwd);
	        ...
	        String empTable ="CREATE TABLE IF NOT EXISTS emp ("+
...
// read the values from employee table
