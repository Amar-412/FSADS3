...
import com.klu.modal.Department;
import com.klu.modal.Employee;
...
public class MainApp {
	...
	private static void insertEmployee(Scanner sc) {
	    ...
	    session.persist(emp); // works same as the safeof method but this doesn't return any id and it works with only object
